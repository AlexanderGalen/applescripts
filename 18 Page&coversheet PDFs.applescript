tell application "Finder"
	set theFile to "hom:products:note card cafe:sets a6:• A6.SingleCards.New Size:Holiday Backup:NCNYH6-00003.Almost Midnight.pdf" as alias
	...
	set finishedFilePath to "hom:products:note card cafe:sets a6:• A6.SingleCards.New Size:Holiday:" & finishedFileName
